...
class servicio extends Conectar {
    ...
    public function agregarServicios($Id_servicio,$tipo_servicio,$costo,$Id_articulo,$Descripcion,$Precio)
    {
      $sqlServicios="INSERT INTO servicios (Id_servicio,tipo_servicio,costo,Id_articulo,Descripcion,Precio) VALUES ('$Id_servicio','$tipo_servicio','$costo','$Id_articulo','$Descripcion','$Precio')";
    ...
    {
      $sqlArticulos="SELECT Id_servicio,tipo_servicio,Descripcion,Precio,costo,Id_articulo FROM servicios WHERE Id_servicio='$Id_servicio'";
    ...
    #Metodo Editar
     public function editarServicio($Id_servicio,$tipo_servicio,$Descripcion,$Precio,$costo,$Id_articulo){
